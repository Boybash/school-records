...
// Helper function to fetch logs from Firestore
...
export default function AdminLogDashboard() {
  ...
  return (
    <div className="min-h-screen bg-primary p-4 sm:p-8 text-gray-800">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b pb-4">
          ...
          <button
            onClick={() => refetch()}
            className="w-full sm:w-auto px-4 py-2 text-sm font-semibold bg-white border rounded-md hover:bg-gray-50 shadow-sm transition flex items-center justify-center gap-2 text-gray-700"
          >
            🔄 Refresh Records
          </button>
        </div>
