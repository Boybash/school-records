...
import { createLog } from "@/lib/activity";
...
export const approveResult = async (
  ...
  await createLog(
    "RESULT_APPROVAL",
    `Approved ${subjectName} result for ${studentName}`,
    currentUser,
  );
};
...
export const rejectResult = async (
  ...
  await createLog(
    "RESULT_REJECTION",
    `Rejected ${subjectName} result for ${studentName}`,
    currentUser,
  );
};

export const updateResult = async (id, resultData, oldScore, currentUser) => {
...
export const deleteResult = async (
  ...
  await createLog(
    "RESULT_DELETION",
    `Permanently deleted ${subjectName} record for ${studentName}`,
    currentUser,
  );
};
...
export const buildResultData = (
  ...
  return {
    ...
    uploadedBy: uid,
    uploadedByName: unploadedName || "Staff Member",
    uplaodedRole: role,
